...
const Main = () => {
  ...
  return (
    <>
      <div className='scrollanimation bg-[#3d3d3d55] m-0 z-20 h-screen w-full flex flex-col justify-center items-center overflow-hidden'>
      ...
      <div className='m-0 z-20 bg-[#3d3d3d55] h-screen w-full flex flex-col justify-center items-center'>
        <div className='m-0 bg-[#3d3d3d55] h-screen w-full z-30 flex flex-col justify-center items-center'>
          <div id='category selector' className='h-[50px] w-[200px] mt-10 mb-2 border border-white rounded-2xl flex flex-row justify-around items-center'>
            {
              categories.map((category)=>(
                <button 
                  key={category.id} 
                  className='cursor-pointer h-[50px] flex flex-col justify-center items-center object-contain text-[12px] font-semibold text-[#3d3d3dd9]'
